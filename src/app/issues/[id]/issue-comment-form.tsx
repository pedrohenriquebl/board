...
export default function IssueCommentForm({ isAuthenticated, onCreateComment }: IssueCommentFormProps) {
    const {
        register,
        handleSubmit,
        reset,
    ...
    return (
        <form className="relative w-full" onSubmit={handleSubmit(handleCreateComment)}>
            <Input
